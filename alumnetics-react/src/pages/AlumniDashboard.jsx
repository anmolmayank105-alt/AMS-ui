...
const AlumniDashboard = () => {
  ...
  const loadDashboardData = useCallback(async () => {
    try {
      console.log('📊 Loading alumni dashboard data...');
      ...
      const [eventsResponse, myEventsResponse] = await Promise.all([
        ...
        api.get(API_ENDPOINTS.EVENTS.MY_EVENTS).catch((err) => {
      ...
      console.log('✅ Loaded upcoming events:', events.length, 'events');
      setUpcomingEvents(events);
      
      // Update my events - handle response.data.events structure
      const myEvents = myEventsResponse.data?.events || myEventsResponse.events || [];
      console.log('✅ Loaded my events:', myEvents.length, 'events');
  ...
  const performSearch = useCallback(async () => {
    ...
    console.log('🚀 ALUMNI SEARCH STARTED - Query:', searchQuery);
    setIsSearching(true);
    setShowResults(true);
          ...
          <nav className="flex-1 p-4">
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="flex items-center space-x-3 px-4 py-3 rounded-xl font-medium text-gray-700 hover:bg-gray-100 transition-all duration-200">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m8 0h2a2 2 0 012 2v6a2 2 0 01-2 2H8a2 2 0 01-2-2V8a2 2 0 012-2h2"></path>
                  </svg>
            ...
            <div className="flex items-center space-x-3 mb-4">
              <div className="w-10 h-10 rounded-full overflow-hidden shadow-lg">
                {user?.profilePicture?.url ? (
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-teal-500 to-cyan-600 flex items-center justify-center text-white font-semibold">
                    <span>{user?.fullName ? user.fullName.charAt(0).toUpperCase() : (user?.name ? user.name.charAt(0).toUpperCase() : 'A')}</span>
                  </div>
                )}
              </div>
              <div className="flex-1">
                <p className="text-sm font-semibold text-gray-800">{user?.fullName || user?.name || 'Alumni'}</p>
                <p className="text-xs text-gray-600">{user?.institution?.name || user?.college || 'Alumni'}</p>
              </div>
            </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-3xl shadow-2xl border border-white/20 p-8 text-white animate-[fadeInUp_0.6s_ease-out] relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-4xl font-bold mb-4">Welcome back, {user?.fullName || user?.name || 'Alumni'}! 👋</h2>
              <p className="text-xl text-purple-100 mb-6">Ready to connect with fellow alumni today?</p>
          ...
          <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 p-6 animate-[fadeInUp_0.6s_ease-out_0.05s]">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">🔍 Search Students & Alumni</h3>
            ...
            <div className="flex gap-4 mb-4">
              ...
              <button onClick={performSearch} className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-medium hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg">
                Search
              </button>
            </div>
          ...
          {/* Quick Action Cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-[fadeInUp_0.6s_ease-out_0.1s]">
            <div className="bg-white/90 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-white/20 hover:shadow-2xl hover:scale-105 transition-all duration-300 pointer-events-auto relative z-10">
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 p-6">
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl border border-blue-100">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium text-blue-800">Build your network by connecting with students and alumni</span>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 p-6 animate-[fadeInUp_0.6s_ease-out_0.3s]">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">Start connecting, attending events, and mentoring students to unlock achievements!</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 bg-white/90 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 p-6 animate-[fadeInUp_0.6s_ease-out_0.3s]">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900">🎓 Recent Student and Alumni Connections</h3>
                  <p className="text-gray-600 text-sm">Connect with fellow graduates and students</p>
                </div>
              </div>
          ...
          {/* Network Stats */}
          <div className="bg-gradient-to-r from-cyan-600 to-blue-600 rounded-3xl shadow-2xl border border-white/20 p-8 animate-[fadeInUp_0.6s_ease-out_0.2s] relative overflow-hidden">
